...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
    ...
    useLayoutEffect(() => {
        const ctx = gsap.context(() => {
            ...
            // Reset hamburger lines to initial state
            gsap.set(plusH, {rotate: 0, y: 0});
            gsap.set(plusV, {rotate: 90, y: 0});
            gsap.set('.hamburger-middle', {opacity: 1, scale: 1});
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <div
                            className="absolute inset-0 rounded-full bg-gradient-to-r from-indigo-400/20 to-purple-400/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                        ...
                        <span
                            className="absolute inset-0 rounded-full bg-white/20 scale-0 group-active:scale-100 group-active:opacity-0 opacity-30 transition-all duration-200"></span>
                ...
                <aside
                    ...
                    ref={panelRef}
                    className={`staggered-menu-panel absolute top-0 ${position === "right" ? "right-0" : "left-0"} h-full bg-white flex flex-col p-[6em_2em_2em_2em] overflow-y-auto z-10 backdrop-blur-[12px]`}
...
.sm-scope .sm-toggle-modern:focus-visible { outline: 2px solid rgba(255, 255, 255, 0.7); outline-offset: 4px; }
